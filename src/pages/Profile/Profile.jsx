...
const Profile = () => {
  ...
  return (
    <div className="">
      ...
      {/* Profile Left & Right Container */}
      <div className="flex flex-col min-[1200px]:flex-row justify-center items-center gap-6 py-10">
        {/* Profile Left - Info Card */}
        <div className="bg-white dark:bg-slate-800 w-full max-w-[450px] h-full rounded-xl py-8 shadow-md dark:text-white">
          {/* Image */}
        ...
        <div className="flex flex-col w-full rounded-xl gap-6">
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-6">
            ...
            <div className="space-y-5">
              {/* Password */}
              <div className="w-full flex flex-col sm:flex-row sm:items-center justify-between gap-4 border rounded-xl p-5 dark:border-slate-700">
                <div>
                  <h3 className="font-semibold dark:text-white">Password</h3>
                </div>
                <button
                  type="button"
                  className="px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-700 text-white transition whitespace-nowrap"
                >
                  Change Password
                </button>
              </div>
